      ...
      <div class="flex items-center justify-between h-16 px-4">
        <div class="flex items-center gap-3">
          ...
          <NuxtLink to="/admin" class="flex items-center gap-2">
            ...
            <span class="text-lg font-bold text-gray-900 hidden sm:block">Admin</span>
          </NuxtLink>
        </div>
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center gap-2">
            ...
            <button @click="handleSignOut" class="text-sm text-gray-600 hover:text-gray-900 hidden sm:block">
              Odjava
            </button>
          </div>
        </div>
...
const navItems = [
  ...
  { to: '/admin/blog', label: 'Blog', icon: '<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21H9a2 2 0 01-2-2V5a2 2 0 012-2h10a2 2 0 012 2v14a2 2 0 01-2 2z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7H5a2 2 0 00-2 2v10a2 2 0 002 2h2"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h8M9 11h8M9 15h5"/></svg>' },
