    ...
    <div v-if="showQuickAdd" class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" @click.self="showQuickAdd = false">
      <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md">
        ...
        <div class="grid grid-cols-2 gap-3">
          <NuxtLink to="/admin/observations/new" class="card text-center hover:border-primary-300" @click="showQuickAdd = false">
...
const navItems = [
  ...
  { to: '/admin/statistics', label: 'Statistike', icon: '<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>' },
]
