...
CREATE POLICY IF NOT EXISTS "education_content_storage_public_read"
  ON storage.objects FOR SELECT
  USING (bucket_id = 'education-content');

CREATE POLICY IF NOT EXISTS "education_content_storage_staff_insert"
...
CREATE POLICY IF NOT EXISTS "education_content_storage_staff_manage"
