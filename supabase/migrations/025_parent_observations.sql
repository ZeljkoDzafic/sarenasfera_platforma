...
CREATE POLICY IF NOT EXISTS "parent_observations_parent_read"
  ON public.parent_observations FOR SELECT
  USING (parent_id = auth.uid());

CREATE POLICY IF NOT EXISTS "parent_observations_parent_insert"
...
CREATE POLICY IF NOT EXISTS "parent_observations_parent_update"
...
CREATE POLICY IF NOT EXISTS "parent_observations_staff_all"
...
CREATE POLICY IF NOT EXISTS "notifications_staff_insert"
...
CREATE POLICY IF NOT EXISTS "parent_observation_storage_public_read"
  ON storage.objects FOR SELECT
  USING (bucket_id = 'parent-observations');

CREATE POLICY IF NOT EXISTS "parent_observation_storage_parent_insert"
...
CREATE POLICY IF NOT EXISTS "parent_observation_storage_staff_manage"
